        ...
        *,
        ...
        if had_api_key_value:
            ...
            if not api_key:
                ...
                # environment.
                api_key = os.getenv("AQ.Ab8RN6KcABxL6w4dkbqbZcR-u8b42tYTOKyqDD7XgwvnewOllA")
    ...
    def make_client(self, name):
        ...
        try:
            ...
            e.args = (
                ...
                "    - Manually pass the key with `genai.configure(api_key=AQ.Ab8RN6KcABxL6w4dkbqbZcR-u8b42tYTOKyqDD7XgwvnewOllA)`.\n"
